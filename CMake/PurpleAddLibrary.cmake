...
function(PURPLE_ADD_LIBRARY NAME)
  ...
  string(REGEX MATCH "^[a-z]+" SHORT_NAME ${THIS_HEADERS_PREFIX})
  ...
  if(THIS_SHARED)
    ...
    if(NOT THIS_EXCLUDE_FROM_ALL)
      purple_install_pdb(${THIS_TARGET} DESTINATION bin COMPONENT ${SHORT_NAME}dev)
  ...
  foreach(HEADER ${THIS_HEADERS})
    ...
    install(FILES ${HEADER}
      DESTINATION include/${THIS_HEADERS_PREFIX}/${DIR} COMPONENT ${SHORT_NAME}dev)
  ...
  if(NOT THIS_EXCLUDE_FROM_ALL)
    install(TARGETS ${THIS_TARGETS}
      ARCHIVE DESTINATION ${LIBRARY_DIR} COMPONENT ${SHORT_NAME}dev
      RUNTIME DESTINATION bin COMPONENT ${SHORT_NAME}lib
      LIBRARY DESTINATION ${LIBRARY_DIR} COMPONENT ${SHORT_NAME}lib
      )
  endif(NOT THIS_EXCLUDE_FROM_ALL)
