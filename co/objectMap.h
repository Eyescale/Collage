...
protected:
    CO_API virtual bool isDirty() const; //!< @internal

    /** @internal */
    CO_API virtual void serialize( DataOStream& os, const uint64_t dirtyBits );

    /** @internal */
    CO_API virtual void deserialize( DataIStream& is, const uint64_t dirtyBits);
